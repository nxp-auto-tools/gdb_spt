...
extern int print_insn_apex		(bfd_vma, disassemble_info *);
...
extern int print_insn_spt2		(bfd_vma, disassemble_info *);
extern int print_insn_spt3		(bfd_vma, disassemble_info *);
